    ...
    d(new medTimeLineParameterPrivate)
{
    ...
    // Time shift display
    d->displayTimeParameter = new medBoolParameter("Display Time", this);
    d->displayTimeParameter->setText("");
    d->displayTimeParameter->setValue(true);

    d->timeShiftParameter = new medDoubleParameter("Display time with shift:", this);
...
void medTimeLineParameter::computeDisplayedTime()
{
...
QString medTimeLineParameter::getDisplayedTime()
{
